...
//------------------------------------------------------------------------------
// from https://gist.github.com/cdacamar/584c6d43a9cca1ccffec3b36ad5dfe3f
...
namespace bisect::bimo
{
    namespace detail
    {
        ...
        template <typename lambda_t> struct composer_t<lambda_t> : lambda_t
        {
    ...
    template <typename... lambda_ts> auto overload(lambda_ts&&... lambdas)
    {
